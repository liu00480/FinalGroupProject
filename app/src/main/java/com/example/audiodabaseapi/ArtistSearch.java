                ...
                if (obj.getString("album").equals("null")) {
                    ...
                    for (int i = 0; i < arr.length(); i++) {
                        ...
                        try {
                            ...
                            album.setAlbumID(o.getString("idAlbum"));
                            album.setArtistID(o.getString("idArtist"));
                            album.setAlbumName(o.getString("strAlbum"));
                            album.setAlbumURL(o.getString("strAlbumThumb"));
                            album.setArtistName(o.getString("strArtist"));
                            album.setIntYear(o.getString("intYearReleased"));
                            album.setDescription(o.getString("strDescriptionEN"));
